...
include 'header.php';
?>
    <div class="uk-text-center <?php if (!count($vars['contents'])) { echo ' uk-margin-large-top'; } ?>">
        <a href="<?php echo $this->getUrl('content_types'); ?>"
           class="uk-button uk-button-success uk-button-large button-huge<?php if (!count($vars['contents'])) { echo ' button-enormous'; } ?> uk-width-1-1">
    ...
    <div class="uk-text-center">
        <a href="<?php echo $this->getUrl('content_types'); ?>"
           class="uk-button uk-button-success uk-button-large<?php if (!count($vars['contents'])) { echo ' button-huge'; } ?> uk-margin-top uk-width-1-1">
            <i class="uk-icon-plus"></i>
            Neue Kategorie
        </a>
    </div>
...
if (count($vars['contents'])) {
    ?>
    <table class="uk-table uk-text-large uk-table-striped uk-table-hover uk-margin-large-top">
    <tr>
        <th width="15"></th>
        <th>
            Titel
