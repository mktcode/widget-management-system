...
<label>
    Anzahl Bilder je Galerie<br>
    <input type="number" class="uk-width-1-1" value="<?php echo $content ? $this->getData('galeriePics', $content->getId()) : ''; ?>" name="galeriePics" placeholder="" required />
</label>
<label>
    FB-App ID<br>
